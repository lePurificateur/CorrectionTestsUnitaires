...
import specification.InterfaceCursor;
...
public class ImplementCursor implements InterfaceCursor
{
	...
	public void reset()
	{
		setPosition(new sources.ImplementPoint(0, 0));
		setDirection(new sources.ImplementPoint(1, 0));
	}
	...
	{
		setDirection(new sources.ImplementPoint(getDirection().getOrd(), -getDirection().getAbs()));
	}
